...
class PomPomGUI:
    def __init__(self, master):
        ...
        self.best_puct_move = None  # NEW: Best move by PUCT score
        self.best_visit_move = None  # NEW: Best move by visit count
    ...
    def draw_board(self):
        ...
        # Draw highlights for best moves
    ...
    def _run_analysis_thread(self):
        ...
        temp_data = {}
        best_p_move, best_puct = None, -float('inf')
        best_v_move, best_visits = None, -1
