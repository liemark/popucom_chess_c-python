...
class PomPomNN(nn.Module):
    """
    泡姆棋的神经网络模型。
    MODIFIED: Removed the legal moves head. Now has three heads: policy, value, and auxiliary soft policy.
    """
    ...
    def forward(self, x):
        ...
        # --- REMOVED: Legal Moves Head Forward Pass ---
        ...
        # MODIFIED: Return three head outputs
