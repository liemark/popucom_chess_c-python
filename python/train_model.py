...
def get_args():
    ...
    *** 已更新：将 ownership-weight 替换为 legal-moves-weight ***
    ...
    parser.add_argument('--legal-moves-weight', type=float, default=0.1, help='合法走法预测损失的权重')
    parser.add_argument('--soft-policy-weight', type=float, default=0.25, help='辅助软策略损失的权重')
